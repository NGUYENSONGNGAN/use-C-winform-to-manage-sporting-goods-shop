...
---HDX
create proc insertHDX (@ma int, @ma_KH int, @ma_NV int, @ngayxuat date, @ghichu nvarchar (1000))
as
insert into HDXuat values (@ma, @ma_KH, @ma_NV, @ngayxuat, 0, 1, @ghichu, null)
go
...
select * from CTHDNhap where Ma_HDN = 32
